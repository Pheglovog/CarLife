...
function createOrgComponentSupplier() {
    ...
    set -x
    fabric-ca-client enroll -u https://admin:adminpw@localhost:17051 --caname ca_component_supplier --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null

    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-17051-ca_component_supplier.pem
    ...
    set -x
    fabric-ca-client register --caname ca_component_supplier --id.name orderer1 --id.secret orderer1pw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering cartire"
    set -x
    fabric-ca-client register --caname ca_component_supplier --id.name cartire --id.secret cartirepw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering carbody"
    set -x
    fabric-ca-client register --caname ca_component_supplier --id.name carbody --id.secret carbodypw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering carinterior"
    set -x
    fabric-ca-client register --caname ca_component_supplier --id.name carinterior --id.secret carinteriorpw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering user"
    set -x
    fabric-ca-client register --caname ca_component_supplier --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering the org admin"
    set -x
    fabric-ca-client register --caname ca_component_supplier --id.name admin1 --id.secret admin1pw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null

    #######################################################################################################################################
    infoln "Generating the orderer1 msp"
    set -x
    fabric-ca-client enroll -u https://orderer1:orderer1pw@localhost:17051 --caname ca_component_supplier -M "${PWD}/organizations/component_supplier.carlife.com/orderers/orderer1.component_supplier.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://cartire:cartirepw@localhost:17051 --caname ca_component_supplier -M "${PWD}/organizations/component_supplier.carlife.com/peers/cartire.component_supplier.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://cartire:cartirepw@localhost:17051 --caname ca_component_supplier -M "${PWD}/organizations/component_supplier.carlife.com/peers/cartire.component_supplier.carlife.com/tls" --enrollment.profile tls --csr.hosts cartire.component_supplier.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://carbody:carbodypw@localhost:17051 --caname ca_component_supplier -M "${PWD}/organizations/component_supplier.carlife.com/peers/carbody.component_supplier.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://carinterior:carinteriorpw@localhost:17051 --caname ca_component_supplier -M "${PWD}/organizations/component_supplier.carlife.com/peers/carinterior.component_supplier.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17051 --caname ca_component_supplier -M "${PWD}/organizations/component_supplier.carlife.com/users/User1@component_supplier.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://admin1:admin1pw@localhost:17051 --caname ca_component_supplier -M "${PWD}/organizations/component_supplier.carlife.com/users/Admin1@component_supplier.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/component_supplier/ca-cert.pem"
    { set +x; } 2>/dev/null
...
function createOrgManufacturer() {
    ...
    set -x
    fabric-ca-client enroll -u https://admin:adminpw@localhost:17052 --caname ca_manufacturer --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null

    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-17052-ca_manufacturer.pem
        OrganizationalUnitIdentifier: client
    PeerOUIdentifier:
        Certificate: cacerts/localhost-17052-ca_manufacturer.pem
        OrganizationalUnitIdentifier: peer
    ...
    set -x
    fabric-ca-client register --caname ca_manufacturer --id.name orderer2 --id.secret orderer2pw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering factory1"
    set -x
    fabric-ca-client register --caname ca_manufacturer --id.name factory1 --id.secret factory1pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering factory2"
    set -x
    fabric-ca-client register --caname ca_manufacturer --id.name factory2 --id.secret factory2pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering user"
    set -x
    fabric-ca-client register --caname ca_manufacturer --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering the org admin"
    set -x
    fabric-ca-client register --caname ca_manufacturer --id.name admin1 --id.secret admin1pw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null

    #######################################################################################################################################
    infoln "Generating the orderer2 msp"
    set -x
    fabric-ca-client enroll -u https://orderer2:orderer2pw@localhost:17052 --caname ca_manufacturer -M "${PWD}/organizations/manufacturer.carlife.com/orderers/orderer2.manufacturer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://orderer:ordererpw@localhost:17052 --caname ca-orderer -M "${PWD}/organizations/manufacturer.carlife.com/orderers/orderer2.manufacturer.carlife.com/tls" --enrollment.profile tls --csr.hosts orderer2.manufacturer.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://factory1:factory1pw@localhost:17052 --caname ca_manufacturer -M "${PWD}/organizations/manufacturer.carlife.com/peers/factory1.manufacturer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://factory2:factory2pw@localhost:17052 --caname ca_manufacturer -M "${PWD}/organizations/manufacturer.carlife.com/peers/factory2.manufacturer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://factory2:factory2pw@localhost:17052 --caname ca_manufacturer -M "${PWD}/organizations/manufacturer.carlife.com/peers/factory2.manufacturer.carlife.com/tls" --enrollment.profile tls --csr.hosts factory2.manufacturer.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the user msp"
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17052 --caname ca_manufacturer -M "${PWD}/organizations/manufacturer.carlife.com/users/User1@manufacturer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the org admin msp"
    set -x
    fabric-ca-client enroll -u https://admin1:admin1pw@localhost:17052 --caname ca_manufacturer -M "${PWD}/organizations/manufacturer.carlife.com/users/Admin1@manufacturer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
    { set +x; } 2>/dev/null
...
function createOrgInsurer() {
    ...
    set -x
    fabric-ca-client enroll -u https://admin:adminpw@localhost:17054 --caname ca_insurer --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null

    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-17054-ca_insurer.pem
        OrganizationalUnitIdentifier: client
    PeerOUIdentifier:
        Certificate: cacerts/localhost-17054-ca_insurer.pem
        OrganizationalUnitIdentifier: peer
    ...
    set -x
    fabric-ca-client register --caname ca_insurer --id.name orderer3 --id.secret orderer3pw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering pcompany"
    set -x
    fabric-ca-client register --caname ca_insurer --id.name pcompany --id.secret pcompanypw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering rcompany"
    set -x
    fabric-ca-client register --caname ca_insurer --id.name rcompany --id.secret rcompanypw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering user"
    set -x
    fabric-ca-client register --caname ca_insurer --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering the org admin"
    set -x
    fabric-ca-client register --caname ca_insurer --id.name admin1 --id.secret admin1pw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null

    #######################################################################################################################################
    infoln "Generating the orderer3 msp"
    set -x
    fabric-ca-client enroll -u https://orderer3:orderer3pw@localhost:17054 --caname ca_insurer -M "${PWD}/organizations/insurer.carlife.com/orderers/orderer3.insurer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://orderer:ordererpw@localhost:17054 --caname ca-orderer -M "${PWD}/organizations/insurer.carlife.com/orderers/orderer3.insurer.carlife.com/tls" --enrollment.profile tls --csr.hosts orderer3.insurer.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://pcompany:pcompanypw@localhost:17054 --caname ca_insurer -M "${PWD}/organizations/insurer.carlife.com/peers/pcompany.insurer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://rcompany:rcompanypw@localhost:17054 --caname ca_insurer -M "${PWD}/organizations/insurer.carlife.com/peers/rcompany.insurer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://rcompany:rcompanypw@localhost:17054 --caname ca_insurer -M "${PWD}/organizations/insurer.carlife.com/peers/rcompany.insurer.carlife.com/tls" --enrollment.profile tls --csr.hosts rcompany.insurer.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the user msp"
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17054 --caname ca_insurer -M "${PWD}/organizations/insurer.carlife.com/users/User1@insurer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the org admin msp"
    set -x
    fabric-ca-client enroll -u https://admin1:admin1pw@localhost:17054 --caname ca_insurer -M "${PWD}/organizations/insurer.carlife.com/users/Admin1@insurer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/insurer/ca-cert.pem"
    { set +x; } 2>/dev/null
...
function createOrgStore() {
    ...
    set -x
    fabric-ca-client enroll -u https://admin:adminpw@localhost:17053 --caname ca_store --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null

    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-17053-ca_store.pem
        OrganizationalUnitIdentifier: client
    PeerOUIdentifier:
        Certificate: cacerts/localhost-17053-ca_store.pem
        OrganizationalUnitIdentifier: peer
    ...
    set -x
    fabric-ca-client register --caname ca_store --id.name sailer1 --id.secret sailer1pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering sailer2"
    set -x
    fabric-ca-client register --caname ca_store --id.name sailer2 --id.secret sailer2pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering user"
    set -x
    fabric-ca-client register --caname ca_store --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering the org admin"
    set -x
    fabric-ca-client register --caname ca_store --id.name admin1 --id.secret admin1pw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null

    #######################################################################################################################################
    infoln "Generating the sailer1 msp"
    set -x
    fabric-ca-client enroll -u https://sailer1:sailer1pw@localhost:17053 --caname ca_store -M "${PWD}/organizations/store.carlife.com/peers/sailer1.store.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://sailer1:sailer1pw@localhost:17053 --caname ca_store -M "${PWD}/organizations/store.carlife.com/peers/sailer1.store.carlife.com/tls" --enrollment.profile tls --csr.hosts sailer1.store.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://sailer2:sailer2pw@localhost:17053 --caname ca_store -M "${PWD}/organizations/store.carlife.com/peers/sailer2.store.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://sailer2:sailer2pw@localhost:17053 --caname ca_store -M "${PWD}/organizations/store.carlife.com/peers/sailer2.store.carlife.com/tls" --enrollment.profile tls --csr.hosts sailer2.store.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the user msp"
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17053 --caname ca_store -M "${PWD}/organizations/store.carlife.com/users/User1@store.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the org admin msp"
    set -x
    fabric-ca-client enroll -u https://admin1:admin1pw@localhost:17053 --caname ca_store -M "${PWD}/organizations/store.carlife.com/users/Admin1@store.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/store/ca-cert.pem"
    { set +x; } 2>/dev/null
...
function createOrgMaintenancer() {
    ...
    set -x
    fabric-ca-client enroll -u https://admin:adminpw@localhost:17055 --caname ca_maintenancer --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null

    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-17055-ca_maintenancer.pem
        OrganizationalUnitIdentifier: client
    PeerOUIdentifier:
        Certificate: cacerts/localhost-17055-ca_maintenancer.pem
        OrganizationalUnitIdentifier: peer
    ...
    set -x
    fabric-ca-client register --caname ca_maintenancer --id.name fixer1 --id.secret fixer1pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering fixer2"
    set -x
    fabric-ca-client register --caname ca_maintenancer --id.name fixer2 --id.secret fixer2pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering user"
    set -x
    fabric-ca-client register --caname ca_maintenancer --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering the org admin"
    set -x
    fabric-ca-client register --caname ca_maintenancer --id.name admin1 --id.secret admin1pw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null

    #######################################################################################################################################
    infoln "Generating the fixer1 msp"
    set -x
    fabric-ca-client enroll -u https://fixer1:fixer1pw@localhost:17055 --caname ca_maintenancer -M "${PWD}/organizations/maintenancer.carlife.com/peers/fixer1.maintenancer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://fixer1:fixer1pw@localhost:17055 --caname ca_maintenancer -M "${PWD}/organizations/maintenancer.carlife.com/peers/fixer1.maintenancer.carlife.com/tls" --enrollment.profile tls --csr.hosts fixer1.maintenancer.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null

    # Copy the tls CA cert, server cert, server keymaintenancer to well known file names in the peer's tls directory that are referenced by peer startup config
    ...
    cp "${PWD}/organizations/maintenancer.carlife.com/peers/fixer1.maintenancer.carlife.com/tls/keymaintenancer/"* "${PWD}/organizations/maintenancer.carlife.com/peers/fixer1.maintenancer.carlife.com/tls/server.key"

    infoln "Generating the fixer2 msp"
    set -x
    fabric-ca-client enroll -u https://fixer2:fixer2pw@localhost:17055 --caname ca_maintenancer -M "${PWD}/organizations/maintenancer.carlife.com/peers/fixer2.maintenancer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://fixer2:fixer2pw@localhost:17055 --caname ca_maintenancer -M "${PWD}/organizations/maintenancer.carlife.com/peers/fixer2.maintenancer.carlife.com/tls" --enrollment.profile tls --csr.hosts fixer2.maintenancer.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    cp "${PWD}/organizations/maintenancer.carlife.com/peers/fixer2.maintenancer.carlife.com/tls/keymaintenancer/"* "${PWD}/organizations/maintenancer.carlife.com/peers/fixer2.maintenancer.carlife.com/tls/server.key"

    infoln "Generating the user msp"
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17055 --caname ca_maintenancer -M "${PWD}/organizations/maintenancer.carlife.com/users/User1@maintenancer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the org admin msp"
    set -x
    fabric-ca-client enroll -u https://admin1:admin1pw@localhost:17055 --caname ca_maintenancer -M "${PWD}/organizations/maintenancer.carlife.com/users/Admin1@maintenancer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/maintenancer/ca-cert.pem"
    { set +x; } 2>/dev/null
...
function createOrgConsumer() {
    ...
    set -x
    fabric-ca-client enroll -u https://admin:adminpw@localhost:17056 --caname ca_consumer --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null

    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-17056-ca_consumer.pem
        OrganizationalUnitIdentifier: client
    PeerOUIdentifier:
        Certificate: cacerts/localhost-17056-ca_consumer.pem
        OrganizationalUnitIdentifier: peer
    ...
    set -x
    fabric-ca-client register --caname ca_consumer --id.name user1 --id.secret user1pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering user"
    set -x
    fabric-ca-client register --caname ca_consumer --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null

    infoln "Registering the org admin"
    set -x
    fabric-ca-client register --caname ca_consumer --id.name admin1 --id.secret admin1pw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null

    #######################################################################################################################################
    infoln "Generating the user1 msp"
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17056 --caname ca_consumer -M "${PWD}/organizations/consumer.carlife.com/peers/user1.consumer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17056 --caname ca_consumer -M "${PWD}/organizations/consumer.carlife.com/peers/user1.consumer.carlife.com/tls" --enrollment.profile tls --csr.hosts user1.consumer.carlife.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null

    # Copy the tls CA cert, server cert, server keyconsumer to well known file names in the peer's tls directory that are referenced by peer startup config
    ...
    cp "${PWD}/organizations/consumer.carlife.com/peers/user1.consumer.carlife.com/tls/keyconsumer/"* "${PWD}/organizations/consumer.carlife.com/peers/user1.consumer.carlife.com/tls/server.key"

    infoln "Generating the user msp"
    set -x
    fabric-ca-client enroll -u https://user1:user1pw@localhost:17056 --caname ca_consumer -M "${PWD}/organizations/consumer.carlife.com/users/User1@consumer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null
    ...
    infoln "Generating the org admin msp"
    set -x
    fabric-ca-client enroll -u https://admin1:admin1pw@localhost:17056 --caname ca_consumer -M "${PWD}/organizations/consumer.carlife.com/users/Admin1@consumer.carlife.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/consumer/ca-cert.pem"
    { set +x; } 2>/dev/null
